...
select count(id) as [MTD_Total Loan Application] from bank_loan_data where month(issue_date) = 12

--PMTD Loan Applications--
select count(id) as [PMTD_Total Loan Application] from bank_loan_data where month(issue_date) = 11
